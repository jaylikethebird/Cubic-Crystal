...
BugCatcherArnieAfterBattleText:
	text "My YANMA is super"
	line "rare, but every"

	para "now and then they"
	line "swarm like crazy!"
	done
...
Route35_MapEvents:
	...
	object_event 13, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route35TMRollout, EVENT_ROUTE_35_TM_DEFENSE_CURL
