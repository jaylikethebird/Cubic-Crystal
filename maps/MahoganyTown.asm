...
MahoganyTownGuardScript:
	jumptextfaceplayer MahoganyTownGuardText
...
MahoganyTownGrampsText:
	...
	para "You can SURF to"
	line "see them up close"
	cont "if you beat our"
	cont "GYM LEADER."
	done
...
MahoganyTownGuardText:
	text "These days, the"
	line "LAKE OF RAGE is"
	
	para "way too dangerous"
	line "for amateurs."

	para "Wanna prove you're"
	line "tough enough to"

	para "see it? Old man"
	line "PRYCE will put"
	cont "you to the test!"
	done
...
MahoganyTownLassText:
	...
	para "TMs that the big"
	line "shop in GOLDENROD"

	para "and her cousin in"
	line "CIANWOOD don't!"
	done
...
MahoganyTown_MapEvents:
	...
	object_event 7,  5, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyTownGuardScript, EVENT_BEAT_PRYCE
