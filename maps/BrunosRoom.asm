...
.rematch
	writetext BrunoScript_BrunoBeforeTextRematch
	waitbutton
	closetext
	winlosstext BrunoScript_BrunoBeatenText, 0
...
BrunoScript_BrunoBeforeTextRematch:
	text "<PLAYER>."
	line "We meet again."

	para "I've trained many"
	line "kinds of #MON"
	cont "over the years."

	para "To prove my might,"
	line "I've mastered rock,"

	para "fighting, and now"
	line "ground-type team-"
	cont "mates."

	para "Training with my"
	line "#MON…"

	para "It is my life!"

	para "Perhaps if this"
	line "team can defeat"

	para "you, I will begin"
	line "the cycle again."
