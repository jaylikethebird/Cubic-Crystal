...
SlowpokeWellB1FBugsyScript:
	jumptextfaceplayer SlowpokeWellB1FBugsyText
...
SlowpokeWellB1FKurtText:
	...
	para "but now the kid's"
	line "insisting that I"
	cont "need first aid."
...
SlowpokeWellB1FBugsyText:
	text "You must be the"
	line "trainer KURT was"
	cont "talking about."
	cont "<PLAYER>, right?"

	para "I'm BUGSY, the GYM"
	line "LEADER of AZALEA"
	cont "TOWN. Howdy!"

	para "I came to look"
	line "into SLOWPOKE WELL"
	cont "with KURT, but he"
	cont "took a hard fall."

	para "Could you check"
	line "things out while I"
	cont "patch him up?"
	done
...
SlowpokeWellB1F_MapEvents:
	...
	object_event  15, 14, SPRITE_BUGSY, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB1FBugsyScript, EVENT_SLOWPOKE_WELL_ROCKETS
