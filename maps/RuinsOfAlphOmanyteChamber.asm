...
NoHelixText:
	text "I've deduced that"
	line "a rare fossil is"
	cont "key to this room."
...
RuinsOfAlphOmanyteChamber_MapEvents:
	...
	object_event  3,  1, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, OmanyteScript, -1
