...
BurnedTowerB1FEusineText:
	text "Amazing. I found"
	line "a secret passage"

	para "to this basement,"
	line "but you beat me"
	cont "to the punch."
	...
	line "such a majestic"
	cont "#MON…"

	para "MORTY's vision is"
	line "crystal clear now."

	para "Just as he seeks"
	line "the rainbow-winged"

	para "bird of legend, I"
	line "must find SUICUNE."

	para "<PLAYER>!"

	para "If you also seek"
	line "SUICUNE, then the"
	cont "race is on!"
...
BurnedTowerB1F_MapEvents:
	...
	object_event 10, 12, SPRITE_KAREN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BurnedTowerB1FEusine, EVENT_EUSINE_IN_BURNED_TOWER
