...
.FightDone:
	...
	waitbutton
	closetext
	setevent EVENT_LAKE_OF_RAGE_PRYCE
...
PryceText_CherishYourPokemon:
	text "I would ask that"
	line "you meet me at"
	cont "the LAKE OF RAGE."

	para "I must attend to"
	line "the angry GYARADOS"
	cont "before they reach"
	cont "MAHOGANY TOWN."

	para "I could use help"
	line "from a spry young"
...
MahoganyGym_MapEvents:
	...
	def_object_events
	object_event  5,  3, SPRITE_PRYCE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, MahoganyGymPryceScript, EVENT_TALK_PRYCE
