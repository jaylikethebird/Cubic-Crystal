...
BugsyText_INeverLose:
	...
	cont "help in the WELL,"

	para "but I'm sorry to"
	line "say that I can't"
	...
	para "on bug #MON in"
	line "the wild has made"

	para "me an authority"
	line "on the subject."

	para "And yeah, that"
	line "also includes how"
	cont "to fight with 'em!"
