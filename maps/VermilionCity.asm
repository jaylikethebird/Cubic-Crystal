...
VermilionCityTeacherText:
	...
	para "past CERULEAN at"
	line "the POWER PLANT."

	para "There's a problem"
	line "with the electric"

	para "system, and nobody"
	line "knows electricity"
	cont "like SURGE!"
	done
...
VermilionCity_MapEvents:
	...
	def_object_events
	object_event 10,  20, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VermilionCityTeacherScript, EVENT_RETURNED_MACHINE_PART
