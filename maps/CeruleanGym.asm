...
.FightDone:
	checkevent EVENT_GOT_RAIN_DANCE
	iftrue .SpeechAfterTM
	writetext MistyCascadeText
	promptbutton
	verbosegiveitem TM_RAIN_DANCE
	setevent EVENT_GOT_RAIN_DANCE
	writetext MistyRainText
	waitbutton
	closetext
	end
...
MistyCascadeText:
	text "What? You're the"
	line "new CHAMPION?"

	para "That explains it!"

	para "Man, that makes me"
	line "feel better about"
	cont "losing to a pest."

	para "Here, you've earned"
	line "my favorite TM!"
	done

MistyRainText:
	text "That's RAIN DANCE."
	
	para "Use it to power"
	line "up water-types"

	para "and weaken fire-"
	line "types."

	para "But look out!"
	line "It makes THUNDER"
	cont "super accurate!"
	done 
