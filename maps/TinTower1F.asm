...
TinTower1FEusineSuicuneText:
	...
	para "That was truly"
	line "inspired, <PLAYER>."

	para "I see why you've"
	line "been accepted by"
	cont "SUICUNE."

	para "I got too caught"
	line "up in the chase,"

	para "and I forgot that"
	line "even legends are"
	cont "still #MON."

	para "They sense your"
	line "kindness."

	para "Your devotion to"
	line "teamwork."

	para "From the meekest"
	line "MAGIKARP to my own"
...
TinTower1F_MapEvents:
	...
	object_event  8,  3, SPRITE_KAREN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TinTower1FEusine, EVENT_TIN_TOWER_1F_EUSINE
