...
SageLiFlashExplanationText:
	...
	para "HMs can be reused,"
	line "so feel free to"
	cont "forget FLASH and"
	cont "relearn it when-" 
	cont "ever you want!"
	done
...
SageLiAfterBattleText:
	...
	para "Remember: HMs are"
	line "reusable, like"
	cont "our ESCAPE ROPE."
	
	para "Forget FLASH and"
	line "relearn it when-" 
	cont "ever you want!"
	done
