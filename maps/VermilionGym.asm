...
LtSurgeIntroText:
	text "Hey there, it's the"
	line "kid CHAMP!"

	para "Thanks to you, my"
	line "electric #MON"

	para "can stop charging"
	line "light bulbs and"

	para "get back to what"
	line "they do best."

	para "My enemies in war"
	line "could tell you all"

	para "about that, but I"
	line "zapped 'em away!"

	para "Wanna test your"
	line "luck, squirt?"
	done
...
SurgeZapText:
	text "That's ZAP CANNON."

	para "It only hits half"
	line "the time, but it"

	para "always paralyzes"
	line "the #MON that"

	para "manage to survive"
	line "the hit."
	done
