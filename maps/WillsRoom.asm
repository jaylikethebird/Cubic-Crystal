...
.oldfriend:
	writetext WillScript_OldFriendBefore
	waitbutton
	closetext
	winlosstext WillScript_WillBeatenText, 0
	loadtrainer WILL, WILL1
...
WillScript_Rematch:
	...
	para "I've been hard"
	line "at work training"

	para "my psychic #MON"
	line "in KANTO."

	para "Just because I'm"
	line "new here doesn't"

	para "mean I'm gonna be"
	line "an easy fight,"

	para "even for a CHAMP."
	line "Let's go!"
	done

WillScript_OldFriendBefore:
	text "Welcome to #MON"
	line "LEAGUE, <PLAYER>."
	...
	line "decipher the RUINS"
	cont "OF ALPH, but you"

	para "got strong enough"
	line "to reach me here."
