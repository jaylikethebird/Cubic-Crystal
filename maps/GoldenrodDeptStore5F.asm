...
GoldenrodDeptStore5FClerkScript:
    ...
    iftrue .headbuttcheckevent
    checkevent EVENT_GOT_TM08_ROCK_SMASH
    iftrue .rocksmashcheckevent
    checkevent EVENT_NATIONAL_PARK_TM_DIG
    iftrue .digcheckevent
    sjump .none

.headbuttcheckevent:
    checkevent EVENT_GOT_TM08_ROCK_SMASH
    iftrue .both_headbutt_rocksmash
    checkevent EVENT_NATIONAL_PARK_TM_DIG
    iftrue .headbutt_dig
    sjump .onlyheadbutt
...
.both_headbutt_rocksmash:
    checkevent 	EVENT_NATIONAL_PARK_TM_DIG
    iftrue .all
	pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Fheadbuttrocksmash
    sjump .exit

.headbutt_dig:
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Fheadbuttdig
    sjump .exit

.onlyheadbutt:
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Fheadbutt
    sjump .exit

.onlyrocksmash:
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Frocksmash
    sjump .exit

.dig_rocksmash:
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Frocksmashdig
    sjump .exit

.onlydig:
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Fdig
    sjump .exit

.none:
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Fnone
    sjump .exit

.all
    pokemart MARTTYPE_STANDARD, MART_GOLDENROD_5Fall
    sjump .exit
.exit:
    closetext
    end
...
GoldenrodDeptStore5FPokefanMText:
	...
	line "other TM vendors"

	para "in CIANWOOD CITY"
	line "and MAHOGANY TOWN."

	para "There's even one"
	line "for GYM LEADER TMs"
