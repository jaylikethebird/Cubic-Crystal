...
.FightDone:
	...
	writetext FalknerText4
	waitbutton
	closetext
	playsound SFX_WARP_TO
	applymovement ROUTE36_FALKNER, FalknerTeleport
	disappear ROUTE36_FALKNER
	end
...
FalknerText4:
	...
	para "It oughtta help,"
	line "because trouble is"
	cont "brewing east and"
	cont "west of ECRUTEAK."

	para "GYARADOS are going"
	line "berserk north of"
	cont "MAHOGANY TOWN,"

	para "and the lighthouse"
	line "over in OLIVINE"
	cont "CITY went dark."
...
Route36_MapEvents:
	...
	object_event 30, 6,  SPRITE_FALKNER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route36FalknerScript, EVENT_FALKNER_ROUTE_36
