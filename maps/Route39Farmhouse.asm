...
FarmerFScript_GiveSnore:
	...
	setevent EVENT_GOT_TM04_ROLLOUT_FROM_MOOMOO_FARM
...
FarmerMText_SickCow:
	...
	para "I called our lil"
	line "WHITNEY home to"
...
FarmerFText_InTrouble:
	...
	line "calling WHITNEY"
	
	para "from the big city,"
	line "but she's so sweet"
	cont "with MILTANK."

	para "It's all hands on"
	line "deck!"
	done
...
FarmerFText_SnoreSpeech:
	...
	line "that gets stronger"

	para "the more it goes."
	line "Our own WHITNEY"

	para "made it famous"
	line "round these parts."
	done
