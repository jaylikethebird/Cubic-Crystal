...
GoldenrodCityRocket4Text:
	text "This house smells"
	line "so good…"

	para "Uh, I mean, grr!"
	line "I'm super tough!"
	cont "And mean!"
	done
...
GoldenrodCity_MapEvents:
	...
	def_object_events
	object_event  8, 22, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityPokefanMScript, EVENT_GOLDENROD_CITY_CIVILIANS
