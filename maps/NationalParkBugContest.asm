...
BugCatchingContestant3AText:
	text "BUGSY: I'm always"
	line "on the look for"
	cont "rare specimens!"
	done
...
NationalParkBugContest_MapEvents:
	...
	object_event  9, 18, SPRITE_BUGSY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant3AScript, EVENT_BUG_CATCHING_CONTESTANT_3A
