	...
	const LAKEOFRAGE_GYARADOS1
	const LAKEOFRAGE_GYARADOS2
	const LAKEOFRAGE_GYARADOS3
	const LAKEOFRAGE_GYARADOS4
...
LakeOfRageGrampsScript:
	...
	checkevent EVENT_GOT_RED_SCALE
	iftrue .TookOutGyarados
	writetext LakeOfRageGrampsText 
	waitbutton
	closetext
	setevent EVENT_TALK_PRYCE
	end
...
.TookOutGyarados
	writetext LakeOfRageGrampsText_TookOutGyarados
	waitbutton
	closetext
	end
...
LakeOfRageGyaradosText:
	text "GYARADOS: Gyashaa!"
	done

Yikes:
	text "It's in a full"
	line "rage! Better not"
...
LakeOfRageGrampsText:
	...
	line "getting angrier"
	cont "and angrier."

	para "I'm doing what I"
	line "can to cool the"

	para "LAKE down and ease"
	line "their rage, but"
	cont "the red GYARADOS"
	cont "must be pacified."

	para "We need a trainer"
	line "with my BADGE and"
	cont "SURF to fix this."

	para "That young JASMINE"
	line "in OLIVINE CITY"
	cont "has a SURF HM…"

	para "Can you help me"
	line "protect MAHOGANY?"
	done

LakeOfRageGrampsText_TookOutGyarados:
	text "Excellent work,"
	line "<PLAYER>. That red"

	para "GYARADOS was a"
	line "serious danger."

	para "We seem to have"
	line "drawn the notice"

	para "of another strong"
	line "young trainer--"

	para "though I suppose"
	line "most of you are"
	cont "youths to me." 

	para "I will continue to"
	line "keep the raging"
	cont "GYARADOS at bay."

	para "If you're willing"
	line "to help us even"
	
	para "further, you'd do"
	line "well to follow"
	cont "young LANCE."
	done
...
LakeOfRage_MapEvents:
	...
	object_event 20, 26, SPRITE_PRYCE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LakeOfRageGrampsScript, -1
	...
	object_event 35,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, LakeOfRageTMDetect, EVENT_LAKE_OF_RAGE_TM_MEGA_PUNCH
	object_event 22, 24, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GyaradosScript, EVENT_CLEARED_ROCKET_HIDEOUT
	object_event 24, 20, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GyaradosScript, EVENT_CLEARED_ROCKET_HIDEOUT
	object_event 17, 26, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GyaradosScript, EVENT_CLEARED_ROCKET_HIDEOUT
	object_event 16, 21, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GyaradosScript, EVENT_CLEARED_ROCKET_HIDEOUT
