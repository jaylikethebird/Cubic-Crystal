	...
	const ROUTE34ILEXFORESTGATE_DIGLETT
...
.GotMudSlap:
	writetext Route34IlexForestGateTeacher_GotMudSlap
	waitbutton
.NoRoom:
	closetext
	end
...
Route34IlexForestGateTeacherText:
	...
	line "fighting WHITNEY?"

	para "She uses a move"
	line "that gives new"
...
Route34IlexForestGateTeacher_GotMudSlap:
	text "It's MUD-SLAP."

	para "Use it to lower"
...
Route34IlexForestGate_MapEvents:
	...
	object_event  9,  4, SPRITE_DIGLETT, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route34IlexForestGateButterfreeScript, -1
