	...
	const INDIGOPLATEAUPOKECENTER1F_CLERKTM
...
IndigoPlateauPokecenter1FClerkScript:
	...
	iftrue .KantoTMS
	pokemart MARTTYPE_STANDARD, MART_INDIGOTM1
	closetext
	end

.KantoTMS
	pokemart MARTTYPE_STANDARD, MART_INDIGOTM2
	closetext
	end

IndigoPlateauPokecenter1FClerkTMScript:
	opentext
...
IndigoPlateauPokecenter1FCooltrainerFText:
	text "The TM shop here"
	line "sells every TM"

	para "that you've earned"
	line "from a GYM LEADER."

	para "If you're looking"
	line "to buy other TMs,"

	para "look in GOLDENROD"
	line "CITY, MAHOGANY"
	
	para "TOWN, and CIANWOOD"
	line "CITY. Oh, and also"

	para "CELADON CITY out"
	line "in KANTO."

	para "If you beat every"
	line "LEADER in KANTO,"

	para "the shop will sell"
	line "their TMs too!"
	done
...
IndigoPlateauPokecenter1F_MapEvents:
	...
	object_event 11,  7, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, IndigoPlateauPokecenter1FClerkScript, -1
	object_event 12,  7, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, IndigoPlateauPokecenter1FClerkTMScript, -1
	object_event 16, 12, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_LEFT, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IndigoPlateauPokecenter1FCooltrainerMScript, -1
	...
	object_event 11, 11, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IndigoPlateauPokecenter1FCooltrainerFScript, -1
