...
VictoryRoad_MapEvents:
	...
	def_object_events
	object_event 9, 65, SPRITE_FALKNER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FalknerScript, EVENT_BEAT_CHAMPION_LANCE
	object_event 11, 54, SPRITE_BUGSY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BugsyScript, EVENT_BEAT_CHAMPION_LANCE
	object_event 10, 39, SPRITE_WHITNEY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WhitneyScript, EVENT_BEAT_CHAMPION_LANCE
	object_event 18, 34, SPRITE_PRYCE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PryceScript, EVENT_BEAT_CHAMPION_LANCE
	object_event 12, 16, SPRITE_JASMINE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, JasmineScript, EVENT_BEAT_CHAMPION_LANCE
	object_event 3, 26, SPRITE_MORTY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MortyScript, EVENT_BEAT_CHAMPION_LANCE
