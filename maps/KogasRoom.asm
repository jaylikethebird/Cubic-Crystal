...
.rematch
	writetext KogaScript_KogaBeforeTextRematch
	waitbutton
	closetext
	winlosstext KogaScript_KogaBeatenText, 0
...
KogaScript_KogaBeforeTextRematch:
	text "CHAMPION!"

	para "You've come back to"
	line "defend your title."
	cont "Good!"

	para "I honed my ninja"
	line "techniques to rise"

	para "from GYM LEADER to"
	line "the ELITE FOUR."

	para "It pleases me to"
	line "see another soul"

	para "dedicated to the"
	line "art of battle."

	para "But be warned!"
	line "I am no mere test!"
