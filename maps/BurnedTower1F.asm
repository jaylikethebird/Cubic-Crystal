...
BurnedTower1FEusineIntroText:
	...
	para "I grew up here in"
	line "ECRUTEAK with my"
	cont "friend MORTY."

	para "As children, we"
	line "were enchanted by"

	para "legends of great"
	line "#MON of old."

	para "We both vowed to"
	line "become powerful"

	para "trainers worthy of"
	line "meeting them."

	para "It's been years,"
	line "but MORTY called"

	para "me from my post at"
	line "INDIGO PLATEAU to"

	para "investigate one of"
	line "his visions…"

	para "I'm sure it sounds"
	line "strange, but he's"

	para "always right about"
	line "these matters."
	done
...
BurnedTower1FMortyText:
	text "As ECRUTEAK's GYM"
	line "LEADER, it's my"

	para "duty to study what"
	line "are said to be the"
	...
	para "And as a seer,"
	line "I know to follow"
	cont "my second sight."

	para "I foresaw my old"
	line "friend KAREN and"

	para "SUICUNE, the beast"
	line "of the north wind,"
	cont "come face to face."
...
BurnedTower1F_MapEvents:
	...
	object_event 12, 12, SPRITE_KAREN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BurnedTower1FEusineScript, EVENT_BURNED_TOWER_1F_EUSINE
