...
TreeMonMaps:
	...
	treemon_map ROUTE_33,                  TREEMON_SET_CITY
	treemon_map ROUTE_34,                  TREEMON_SET_CITY
	treemon_map ROUTE_35,                  TREEMON_SET_CITY
	treemon_map ROUTE_36,                  TREEMON_SET_CITY
	...
	treemon_map LAKE_OF_RAGE,              TREEMON_SET_CANYON
	treemon_map SILVER_CAVE_OUTSIDE,       TREEMON_SET_KANTO
	treemon_map ILEX_FOREST,               TREEMON_SET_ROUTE
	db -1
