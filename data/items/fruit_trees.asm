...
; entries correspond to FRUITTREE_* constants
	...
	db MIRACLEBERRY ; ROUTE_2
	db GOLD_BERRY   ; ROUTE_1
	db MIRACLEBERRY ; ROUTE_8
	db GOLD_BERRY   ; PEWTER_CITY_1
	db MIRACLEBERRY ; PEWTER_CITY_2
