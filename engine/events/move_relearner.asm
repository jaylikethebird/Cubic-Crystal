...
;.loop ;part of learning previous evolutions moves (broken)
	ld a, [wCurPartySpecies]
	dec a
	push bc
	ld b, 0
...
.loop_moves
	...
	jr .loop_moves
.done
	;farcall GetPreEvolution ; ;part of learning previous evolutions moves (broken)
	pop bc
	;jr c, .loop ;part of learning previous evolutions moves (broken)
	pop af
	ld [wCurPartySpecies], a
	ld a, b
	ld [wd002], a
